...
# The Dataset Journey in openESM
...
```mermaid
flowchart TD
    A([Submission via\nGitHub issue or literature review]) --> B[Registration & ID assignment\ncuration sheet]
